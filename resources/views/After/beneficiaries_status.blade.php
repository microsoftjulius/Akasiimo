    ...
    <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures" style="background-color: black">
        <div class="nano">
            ...
            <ul>
                    ...
                    <li class="active" style="color: red"><a href="/beneficiaries-status"><i class="fa fa-battery-three-quarters" style="color: red"></i> Beneficiaries Status </a></li> -->
                </ul>
            </div>
        </div>
    </div>
